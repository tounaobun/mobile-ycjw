...
public class WheelView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = Color.WHITE;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x83CCEA,
		0x83CCEA, 0x83CCEA };
