...
import zjut.soft.finalwork.query.StudentCourseTableQuery;
...
public class ChooseSemesterUIForCourseTable extends Activity {
	...
	private void loadSemesterItems() {
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					List<String> items = new StudentQueryManager().getStudentCourseTableQuery().getSemesters(ChooseSemesterUIForCourseTable.this);
					...
					mHandler.post(new Runnable() {
						...
						public void run() {
							...
							semesterWV.setCurrentItem((Integer)app.get("selected_semester_index_for_course_name"));
							nextBtn.setText("下一步");
	...
	private void initComponents() {
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				ChooseSemesterUIForCourseTable.this.finish();
			}
		});
		...
		nextBtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ChooseSemesterUIForCourseTable.this,StudentCourseTableQueryUI.class);
